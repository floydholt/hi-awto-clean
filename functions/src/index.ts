...
import { writeLead } from "./submit-lead";
...
// LOG WRITER
// -----------------------------
async function writeLog(type: string, message: string, meta: any = {}) {
...
// -----------------------------
export const tagListing = onCall(
  { secrets: [AI_API_KEY], region: "us-central1" },
  async (request) => {
