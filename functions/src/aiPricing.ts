...
export async function generateAIPricing(input: PricingInput): Promise<AIPricing> {
  const fallback: AIPricing = {
  ...
  const prompt =
    "You are an assistant estimating a fair list price for a residential property in the US. " +
