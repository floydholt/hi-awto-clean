    ...
    <div className="card" id="apply">
      <form onSubmit={submit}>
        <div className="form-row">
          ...
          <input className="input" name="email" value={form.email} onChange={handleChange} placeholder="Email" required />
        </div>
        <div className="form-row">
          <input className="input" name="phone" value={form.phone} onChange={handleChange} placeholder="Phone" />
        </div>
        <div style={{marginBottom:12}}>
          <textarea className="input" rows="5" name="message" value={form.message} onChange={handleChange} placeholder="Tell us about the home or area you want..." />
        </div>
